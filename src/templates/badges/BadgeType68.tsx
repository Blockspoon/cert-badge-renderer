...
const BadgeType68 = forwardRef<SVGSVGElement, ISvgProps>(
  (
    {
      mainColor = "#96A6B4",
      subColor = "#96A6B4",
...
BadgeType68.displayName = "BadgeType68";

export default BadgeType68;
