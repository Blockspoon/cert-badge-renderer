...
export function createBadgeType81({
  mainColor = "#96A6B4",
  subColor = "#96A6B4",
  extraColor1 = "#96A6B4",
  extraColor2 = "#96A6B4",
  ...
  return `
    <svg
      ...
      "
    >
      <g clipPath="url(#clip0_3052_51933)">
        <rect x="32" y="32" width="536" height="536" fill={extraColor2} />
        <path d="M503 32V52H52V532H32V32H503Z" fill="${mainColor}" />
        <mask
          id="mask0_3052_51933"
        ...
        <path d="M60 60H494V168H60V60Z" fill="${mainColor}" />
        <path
      ...
      <defs>
        <clipPath id="clip0_3052_51933">
          <rect width="600" height="600" fill={extraColor2} />
        </clipPath>
      </defs>
    </svg>
  `;
