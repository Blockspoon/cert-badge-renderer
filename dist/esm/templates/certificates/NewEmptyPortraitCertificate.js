...
exports.createNewEmptyPortraitCertificate = createNewEmptyPortraitCertificate;
function createNewEmptyPortraitCertificate({ mainColor = "#96A6B4", subColor = "#96A6B4", extraColor1 = "#96A6B4", extraColor2 = "#96A6B4", }) {
