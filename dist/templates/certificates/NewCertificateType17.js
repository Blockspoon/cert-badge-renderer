...
exports.createNewCertificateType17 = createNewCertificateType17;
function createNewCertificateType17({ mainColor = "#96A6B4", subColor = "#96A6B4", extraColor1 = "#96A6B4", extraColor2 = "#96A6B4", }) {
    ...
    return `
      ...
      >
         <g clipPath="url(#clip0_1917_1877)">
          ...
          <path
            d="M1052.47 284.497C1050.5 284.387 1047.52 284.583 1045.9 283.601C1044.17 282.545 1043.97 280.482 1043.76 278.934C1043.71 278.566 1043.7 278.075 1043.69 277.719L1043.36 269L1042.91 278.468C1042.91 278.468 1042.83 281.894 1041.74 282.938C1040.03 284.817 1036.45 284.362 1033.83 284.497V284.718C1036.63 284.903 1040.49 284.46 1041.95 286.794C1043.53 289.336 1043.08 295.537 1043.24 298.521C1043.26 298.975 1043.17 299.528 1043.24 299.958C1043.26 300.105 1043.29 300.24 1043.54 300.216C1043.58 298.57 1043.49 296.925 1043.54 295.279C1043.6 293.167 1043.63 290.92 1044.06 288.832C1044.96 284.522 1047.76 284.976 1052.51 284.706C1052.69 284.706 1052.7 284.485 1052.51 284.473L1052.47 284.497Z"
            fill="black"
          />
          <path
          ...
          <rect
            ...
            stroke="black"
          />
          <path d="M996.848 566H348.848" stroke="#002333" /> */}
          <rect x="763.848" y="622" width="80" height="80" />
          <rect x="872.848" y="622" width="80" height="80" />
          <rect x="981.848" y="622" width="80" height="80" />
          <rect
            x="408.848"
            y="70"
            width="60"
            height="60"
            transform="rotate(90 408.848 70)"
            fill="url(#pattern0_1917_1877)"
          />
          <mask
            id="mask0_1917_1877"
          ...
          <g mask="url(#mask0_1917_1877)">
            <path
              opacity="0.6"
              d="M174.848 381C246.645 381 304.848 358.167 304.848 330C304.848 301.833 246.645 279 174.848 279C103.051 279 44.8477 301.833 44.8477 330C44.8477 358.167 103.051 381 174.848 381Z"
              fill="white"
            />
            <path
            ...
            <path
              opacity="0.8"
              d="M174.848 153C246.645 153 304.848 130.167 304.848 102C304.848 73.8335 246.645 51 174.848 51C103.051 51 44.8477 73.8335 44.8477 102C44.8477 130.167 103.051 153 174.848 153Z"
              fill="white"
            />
            <path
            ...
            <path
              opacity="0.8"
              d="M174.848 744C246.645 744 304.848 721.167 304.848 693C304.848 664.833 246.645 642 174.848 642C103.051 642 44.8477 664.833 44.8477 693C44.8477 721.167 103.051 744 174.848 744Z"
              fill="white"
            />
            <path
              opacity="0.6"
              d="M174.848 632C246.645 632 304.848 609.167 304.848 581C304.848 552.833 246.645 530 174.848 530C103.051 530 44.8477 552.833 44.8477 581C44.8477 609.167 103.051 632 174.848 632Z"
              fill="white"
            />
            <path
          ...
          >
            <path
              d="M355.047 702.888H462.447V716.446C462.447 727.492 453.493 736.446 442.447 736.446H357.447C356.121 736.446 355.047 735.372 355.047 734.046L355.047 702.888Z"
              fill="#FFFCF7"
            />
          </mask>
        </g>
        <defs>
          <pattern
            id="pattern0_1917_1877"
            patternContentUnits="objectBoundingBox"
            width="1"
            height="1"
          ></pattern>
          <pattern
            id="pattern1_1917_1877"
            patternContentUnits="objectBoundingBox"
            width="1"
            height="1"
          >
          ...
          <image id="image0_1917_1877" width="357" height="357" />
          <image id="image1_1917_1877" width="360" height="360" />
        </defs>
      </svg>
  `;
}
